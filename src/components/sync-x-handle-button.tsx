  ...
  return (
    <div className="mt-3 space-y-2">
      ...
      <button
        ...
        onClick={() => void onSync()}
        disabled={loading}
        className="rounded-md border border-amber-500/30 bg-amber-950/30 px-2.5 py-1.5 text-[10px] font-medium text-amber-100/90 transition hover:border-amber-500/50 disabled:opacity-50"
      >
